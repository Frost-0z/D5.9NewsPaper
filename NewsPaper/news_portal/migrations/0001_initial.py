...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('post_type', models.CharField(choices=[('news', 'Новости'), ('article', 'Статья')], default='news', max_length=10)),
        ...
        migrations.AddField(
            model_name='post',
            name='category',
            field=models.ManyToManyField(related_name='category', through='news_portal.PostCategory', to='news_portal.category'),
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
        ...
        migrations.AddField(
            model_name='category',
            name='post',
            field=models.ManyToManyField(related_name='post', through='news_portal.PostCategory', to='news_portal.post'),
        ),
    ]
